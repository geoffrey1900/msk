...
var cfg = require('../4tdm config.json');
//var cfg = require('../4tdm ncrn config.json');
//var cfg = require('../ffa config.json');
//var cfg = require('../2tdm config.json');
//var cfg = require('../2tdm ocrn config.json');
//var cfg = require('../beta-testing config.json');
//var cfg = require('../no_kill config.json');
//var cfg = require('../yellow config.json');
//var cfg = require('../large 4tdm config.json');
//var cfg = require('../large ffa config.json');
//var cfg = require('../large 4dom config.json');
