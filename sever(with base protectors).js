...
//const c = require('./4tdm config.json');
//const c = require('./4tdm ncrn config.json');
//const c = require('./ffa config.json');
//const c = require('./2tdm config.json');
//const c = require('./2tdm ocrn config.json');
//const c = require('./beta-testing config.json');
        ...
        connect: (() => {
            ...
            const spawn = (() => {
                ...
                return (socket, name) => {
                    ...
                    body.sendMessage('Big thanks to Reese#3351 on discord. he helped alot');
                        ...
                        function flattener() {
                            ...
                            return {
                                update: (data) => {
                                    ...
                                    // Add new data and stabilze existing data, then remove old data
                                    data.forEach(d => {
                        ...
                        return (room.gameMode === 'ffa') ? 
                            ...
                            (() => {
                                ...
                                return () => {
                                    // Updates
                                    let clean =                                  
                                        publicmap.update(minimap.map(function(entry) {
